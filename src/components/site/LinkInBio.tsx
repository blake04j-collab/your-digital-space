  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto flex min-h-screen max-w-md flex-col items-center px-5 pb-10 pt-10">
        ...
        <div className="mt-4 text-center text-[13px] lowercase leading-tight tracking-[0.25em] text-muted-foreground">
          <p>i ♡ scaling</p>
        </div>
          ...
          <div className="relative flex items-center gap-4 p-4">
            <div className="grid h-14 w-14 shrink-0 place-items-center rounded-xl bg-background/60 backdrop-blur">
              <img
                ...
                alt=""
                aria-hidden
                className="h-10 w-auto drop-shadow-[0_0_10px_oklch(0.82_0.16_220_/_0.8)]"
              />
            </div>
