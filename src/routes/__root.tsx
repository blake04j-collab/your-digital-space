...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Cloud Agency" },
      { name: "description", content: "Management Agency" },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Cloud Agency" },
      { property: "og:description", content: "Management Agency" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Cloud Agency" },
      { name: "twitter:description", content: "Management Agency" },
